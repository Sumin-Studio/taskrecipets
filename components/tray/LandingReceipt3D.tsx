...
export function LandingReceipt3D({
  receipt,
  active,
  onReady,
  onComplete,
  ...
  return (
    <div
      className="absolute left-0 w-[380px] pointer-events-none z-[120]"
      style={{
        top: -PRINTER_TO_STACK_OFFSET,
        height: canvasHeight,
    ...
    >
      <Canvas
        ...
        dpr={[1, 2]}
        style={{ width: STACK_W, height: canvasHeight }}
      >
        <LandingReceiptMesh
          receipt={receipt}
          active={active}
...
function LandingReceiptMesh({
  ...
  useFrame((_, delta) => {
    ...
    const travel = startY + (endY - startY) * progress;
